...
const ISPModal = ({
  thisModal, state, handleChange, handleSubmit,
}) => (
  <div>
          ...
          <form className="col s12" onSubmit={handleSubmit}>
            <div className="row">
              ...
              <div className="input-field col s6">
                ...
                <textarea id="icon_prefix2" name="description" className="materialize-textarea" value={state.description} onChange={handleChange} />
